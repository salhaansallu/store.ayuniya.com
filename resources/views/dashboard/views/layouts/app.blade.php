            ...
            <div class="nav_item">
                <ul>
                    @if (isAdmin())
                        ...
                        <li><a href="/web-admin/appointment"><i class="fa-solid fa-clipboard-check"></i> Appointments ({{ appointments(date("Y-m-d"), date("Y-m-d", strtotime('+365 days')), true) }})</a></li>
                        <li><a href="/web-admin/users"><i class="fa-regular fa-user"></i> Users</a></li>
                    @endif
                    @if (isOrderManager())
                        <li><a href="/print-orders" class="active"><i class="fa-solid fa-print"></i> Print orders</a></li>
                    @endif
                </ul>
            </div>
        </div>
        ...
        <div class="dashboard">
            <div class="top_section">
                <div class="bread_crumb">
                    <div class="dashboard_label"><h1>Dashboard</h1></div>
                ...
                <div class="analytics">
                    <div class="row row-cols-4">
                        ...
                        <div class="col">
                            <div class="inner">
                                ...
                                <div class="details">
                                    ...
                                    <div class="amt">{{ appointments(date("Y-m-d"), date("Y-m-d", strtotime('tomorrow')), true) }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="inner">
                                <div class="image">
                                    <img src="{{ asset('assets/images/brand/favicon.png') }}" style="height: 100%;" alt="">
                                </div>
                                <div class="logout" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">Logout <i class="fa-solid fa-arrow-right-from-bracket"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
