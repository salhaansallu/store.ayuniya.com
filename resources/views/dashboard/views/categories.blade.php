            ...
            <tbody>
              @foreach ($categories as $category)
                <tr>
                  ...
                  <td><button type="button" onclick="updateCategory('{{ $category->id }}', '{{ $category->category_name }}')"><i class="fa-solid fa-pen"></i></button> <button onclick="deleteCategory('{{ $category->id }}')"><i class="fa-solid fa-trash"></i></button></td>
                </tr>
              @endforeach
            </tbody>
        </table>
      ...
      <div class="modal-content">
        <div class="modal-body">
          <form action="" onsubmit="return false;" method="post" id="CategoryUpdateForm">
            ...
            <div class="input">
              <input type="hidden" name="updateid" id="updateid" value="" required> <input type="text" name="updatename" id="updatename" value="" required> <button class="secondary_btn" type="submit">Update</button>
            </div>
          </div>
          </form>
        </div>
      ...
      <div class="modal-content">
        <div class="modal-body">
          <form action="" onsubmit="return false;" method="post" id="AddCategoryForm">
            ...
            <div class="label">Category name</div>
            <div class="input">
              <input type="text" name="createcategory" id="createcategory" required> <button type="submit" class="secondary_btn">Create</button>
            </div>
            </div>
          </form>
        </div>
