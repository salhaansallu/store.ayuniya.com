...
@section('content')
    ...
    <div class="carousel site-container">
    ...
    <div class="services">
        ...
        <div class="row row-cols-2">
            ...
            <div class="col">
                ...
                <div class="text">World's first fully automated all in one booking service including ayurvedic and herbal
                    medicine hospitals.</div>
            </div>
        </div>
    </div>
        ...
        <div class="row row-cols-2">
            <div class="col">
                <div class="content">
                    ...
                    <div class="sub">Ayuniya is the world's first automated herbal product marketplace and automated
                        ayurvedic and herbal medicine hospital booking service proudly presented by <strong>DEF TESNO (PVT)
                            LTD</strong></div>
    ...
    <div class="testimonial">
        ...
        <div class="row row-cols-2">
            <div class="col">
                ...
                <div class="say">
                    This is a useful and easy service for people who want to buy medicines online. People will appreciate
                    the convenience to get these medicines from the comfort of their own home and having them delivered
                    right to their door.
            ...
            <div class="col">
                ...
                <div class="say">
                    ...
                    and ordered the goraka choornaya from Ayuniya website they delivered the the Products within a week to
                    my home in Sri Lanka. Thank you so much.
                    <div class="commenter">
                        Ayshwarya Ayurveda
                    </div>
                </div>
        ...
        <div class="row row-cols-2">
            <div class="col">
                ...
                <div class="dtls">
                    ...
                    <div class="email">Phone number : <span>+94 76 429 2602</span></div>
            ...
            <div class="col">
                ...
                <form method="POST" action="{{ route('saveContactus') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="txt_field">
                        ...
                        <div class="alert-danger text-danger">{{ $errors->first('message') }}</div>
